...
def filter_files(filename, dd, mm, yyyy):
    ...
    Example usage:
    filter_files('2023-01-01_data.csv', 1, 1, 2023)  # Returns True for matching date.
    filter_files('2023-02-15_data.csv', 1, 1, 2023)  # Returns False for non-matching date.
    filter_files('sample_file.csv', 1, 1, 2023)  # Returns False for a filename without a date.
    """
